{
  ...
  src = fetchFromGitHub {
    ...
    rev = "790206ec3197a8b932665aed9ec43703b9d06fa0";
    hash = "sha256-IuwOpC2u4VLNHMJqOlU+7L1vQ79SeiaHWF0i2oLQBVQ=";
  };
...
in
  rustPlatform.buildRustPackage (finalAttrs: {
    ...
    cargoHash = "sha256-wXnkollaRG83OogSa6yedPKmGycFKjQ+Q/S4GxqmLPo=";
