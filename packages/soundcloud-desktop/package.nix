{
  ...
  src = fetchFromGitHub {
    ...
    rev = "1fe696e28867ddc174499089a177bdfd328bc37d";
    hash = "sha256-6O6nmizx1fOQ1mbZ/35Gp3dwfy5Px35WDyqyPGh7A4I=";
  };
...
in
  rustPlatform.buildRustPackage (finalAttrs: {
    ...
    cargoHash = "sha256-FBnGUQM+OP0i+YTwhN1bVJ7Oz/jbvSzfbGt/sJ1m7YM=";
